<template>
  <div class="admin-login">
    <el-form label-width="80px">
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit" style="margin-left: 7px;">立即登录</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
